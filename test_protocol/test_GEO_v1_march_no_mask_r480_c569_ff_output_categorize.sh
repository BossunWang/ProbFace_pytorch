CUDA_VISIBLE_DEVICES=4 python test_1N_type.py \
    --test_set 'GEO_v1_march_no_mask_r480_c569_ff_output_categorize' \
    ...
    2>&1 | tee log/GEO_v1_march_no_mask_r480_c569_ff_output_categorize.log
...
CUDA_VISIBLE_DEVICES=4 python test_1N_type.py \
    ...
    2>&1 | tee -a log/GEO_v1_march_no_mask_r480_c569_ff_output_categorize.log
